...
echo Network
reg add HKEY_CLASSES_ROOT\CLSID\{F02C1A0D-BE21-4350-88B0-7367FC96EF3C}\ShellFolder /t REG_DWORD /v Attributes /d b0940064 /f
reg add HKEY_CLASSES_ROOT\Wow6432Node\CLSID\{F02C1A0D-BE21-4350-88B0-7367FC96EF3C}\ShellFolder /t REG_DWORD /v Attributes /d b0940064 /f
