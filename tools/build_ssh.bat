...
cmake .. 								^
 ...
 -DZLIB_LIBRARY="%ZLIB_DIR%/lib/zlib.lib" 


:: -DCMAKE_C_STANDARD_LIBRARIES="%ZLIB_DIR%\lib\zlib.lib %OPENSSL_DIR%\lib\libeay32.lib ws2_32.lib kernel32.lib user32.lib gdi32.lib winspool.lib shell32.lib ole32.lib oleaut32.lib uuid.lib comdlg32.lib advapi32.lib 
